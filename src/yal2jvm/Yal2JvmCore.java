/* Generated By:JJTree&JavaCC: Do not edit this line. Yal2JvmCore.java */
package yal2jvm;
import custom.Logger;

public class Yal2JvmCore/*@bgen(jjtree)*/implements Yal2JvmCoreTreeConstants, Yal2JvmCoreConstants {/*@bgen(jjtree)*/
  protected static JJTYal2JvmCoreState jjtree = new JJTYal2JvmCoreState();static final Logger LOGGER = Logger.INSTANCE;
...
try {Token t;
  ...
  static public Yal2JvmCoreTokenManager token_source;
  ...
  public Yal2JvmCore(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Yal2JvmCore(java.io.InputStream stream, String encoding) {
    ...
    token_source = new Yal2JvmCoreTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Yal2JvmCore(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Yal2JvmCore(Yal2JvmCoreTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(Yal2JvmCoreTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
